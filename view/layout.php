    ...
    <body>
        ...
        <footer class="piepagina">
            <p>
                ...
                <button type="submit" form="layoutForm" name="tecnologias" value="tecnologias" class="tecnologias"><img src="../207DWESAplicaccionFinalAlberto2022/webroot/css/img/tecnologias.png" class="imagetecnologias" alt="IconoTecnologias" /></button>
