<header class="tituloaplicacion">
    <p class="tituloh1"><img src="../207DWESAplicaccionFinalAlberto2022/webroot/css/img/logotipo.png" class="imagelogo" alt="IconoWebImitada" /></p><p class="tituloh2">Inicio Publico</p>
    <form class="formularioIndex" method="post">
...
<div class="conjuntocajas">
    <div class="cajapublica">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/220119CatalogoDeRequisitos.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/220119DiagramaDeCasosDeUso.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/220119DiagramaDeClases.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/220119ArbolDeNavegacion.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/220119RelacionDeFicheros.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
        ...
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/211129EstandarDesarrolloDAWyEstructuraAlmacenamientoDWES.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
    <div class="cajapublica">
        <div class="imagencaja">
    ...
    <div class="cajapublica">
        <div class="imagencaja">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/usodeapis.pdf" target="_blank"><img src="../207DWESAplicaccionFinalAlberto2022/webroot/css/img/usodeapis.PNG" class="imagencajaimg" alt="IconoAtras" title="Uso de API's"/></a>
        </div>
        <div class="descripcioncaja">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/usodeapis.pdf" target="_blank" class="ainicio"><p>Como usar las API's de mi web</p></a>
        </div>
        <div class="verdocumento">
            <a href="../207DWESAplicaccionFinalAlberto2022/webroot/css/pdf/usodeapis.pdf" target="_blank" class="ainicio"><p>Ver documento</p></a>
        </div>
    </div>
</div>
