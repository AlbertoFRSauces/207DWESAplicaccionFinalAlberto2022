<?php
/*
 * Controlador de ConsultarModificarDepartamento
 * 
 * Controlador que permite controlar la accion que se realiza cuando se pulse el boton de modificar o cancelar
 * 
 * @package: AppFinal
 * @author: Alberto Fernandez Ramirez
 * @since: 24/02/2022
 * @version: 1.0 Realizacion de cConsultarModificarDepartamento
